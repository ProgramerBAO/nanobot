...
SETUP_SPEC = ChannelSetupSpec(
    fields={
        ...
        "quoteGroupReplies": field("bool", default=False, snapshot=False),
        "followBotThreads": field("bool", default=False, snapshot=False),
        "mentionThreadSender": field("bool", default=False, snapshot=False),
    },
